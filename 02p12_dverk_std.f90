!-------------------------------------------------
!  ORIGINAL DVERK SUBROUTINE - withouth EV -
!-------------------------------------------------
...
subroutine dverk_std(n, fcn, x, y, xend, tol, ind, c, nw, w)
use Precision
use AMLUtils
integer n, ind, nw, k
...
! GBD-desiger MOD START:
!           removing write(*,*) and call MpiStop
