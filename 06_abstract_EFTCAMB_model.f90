...
module EFTCAMB_abstract_model
    ...
    contains
        ...
        !> sampling MOD START, not deferred but overwritten
        procedure:: init_model_parameters_for_sampling => EFTCAMBModelInitModelParametersSampling!< subroutine that reads the parameters of the model for sampling.
        !> sampling MOD END
