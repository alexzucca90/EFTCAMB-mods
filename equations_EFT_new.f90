...
!> EFTCAMB MOD START: here I need to insert the quantities for EFTCAMB sources
        ...
        !> Then compute the remaining quantities fot EFTCAMB sources
...
!> EFTCAMB MOD START: here we start with the CAMB sources modifications
