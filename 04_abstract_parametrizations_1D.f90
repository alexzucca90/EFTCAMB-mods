...
module EFTCAMB_abstract_parametrizations_1D
    ...
    contains
        ...
        procedure :: init_from_code        => ParametrizedFunction1DInitFromCode           !< subroutine that reads a Ini file looking for the parameters of the function.
...
! ---------------------------------------------------------------------------------------------
!> Subroutine that reads a Ini file looking for the parameters of the function.
subroutine ParametrizedFunction1DInitFromCode( self, x, y )
...
end subroutine ParametrizedFunction1DInitFromCode
